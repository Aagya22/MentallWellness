...
class AdminProfileSettingsScreen extends ConsumerStatefulWidget {
  const AdminProfileSettingsScreen({super.key});

  @override
  ConsumerState<AdminProfileSettingsScreen> createState() =>
      _AdminProfileSettingsScreenState();
}

class _AdminProfileSettingsScreenState
    extends ConsumerState<AdminProfileSettingsScreen> {
